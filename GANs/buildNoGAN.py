...
def handlerTimerGANno(signum, frame):
    #print("Time over")
    raise Exception("Time over")

def configureTrainingNo(dataDim, dataset, pathResult, timeout):
    ...
    if(timeout == 0):
        ...
        signal.signal(signal.SIGALRM, handlerTimerGANno)
    ...
    generator.save(pathResult + '/my_model_no')
